...
```bash
bash <(curl -s https://gist.githubusercontent.com/ТВОЙ_ЮЗЕР/ТВОЙ_ХЭШ/raw/bootstrap.sh)
# или
wget -qO- https://gist.githubusercontent.com/ТВОЙ_ЮЗЕР/ТВОЙ_ХЭШ/raw/bootstrap.sh | bash
```
