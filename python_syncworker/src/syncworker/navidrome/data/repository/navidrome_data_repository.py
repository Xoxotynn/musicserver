...
class NavidromeDataRepository(NavidromeRepository):
    ...
    def _get(self, endpoint: str, params: dict[str, str] | list[tuple[str, str]] | None = None) -> dict[str, Any]:
        payload = self.client.get(endpoint, params).payload
    ...
    def _map_song(raw_song: dict[str, Any]) -> NavidromeSong | None:
        ...
        path = str(raw_path)
        soundcloud_id = NavidromeDataRepository._extract_soundcloud_id(path)
